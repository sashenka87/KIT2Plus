...
<p><b>41.<?php echo $questions[40];?></b><br />

<div class ="scale" style = "display: inline">SD |</div>
<?php	for ($y=1;$y<=100;$y++){?>
<div id = "dash" y=<?php echo "\"".$y."\""; ?> onclick= <?php echo "\"goTo('".$i."','question','../second/1.php','".$y."','".$questions[$m]."')\"";?> class="scale" style = "display: inline">-</div>
<?php } ?>
