...
window.onload = function(){
	...
	if(Demos[4]){
	  CreateDragContainer(document.getElementById('DragContainer4'), document.getElementById('DragContainer5'), document.getElementById('DragCon'));
	}
	if(Demos[0] || Demos[4]){
		// Create our helper object that will show the item while dragging
		dragHelper = document.createElement('DIV');
		dragHelper.style.cssText = 'position:relative;display:none;';
